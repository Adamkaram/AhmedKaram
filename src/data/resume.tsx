...
export const DATA = {
  ...
  avatarUrl: "https://scontent-hbe1-1.xx.fbcdn.net/v/t39.30808-6/343304471_1185816755504055_4155424635687453637_n.jpg?_nc_cat=104&ccb=1-7&_nc_sid=6ee11a&_nc_ohc=ryScFBepXuAQ7kNvgE7RLPn&_nc_ht=scontent-hbe1-1.xx&oh=00_AYAncy0nDdCnIPKiTtj-esOyygqFqJEkVlNWM52TOXWrjA&oe=6690C474",
  skills: [
    "Vue",
    "React",
    "Next.js",
  ...
  contact: {
    ...
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/adamkaram/",
        icon: Icons.github,
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/ahmedqarum/",
        icon: Icons.linkedin,
      ...
      X: {
        name: "X",
        url: "https://twitter.com/JuavaScript",
        icon: Icons.x,
      ...
      Youtube: {
        name: "Youtube",
        url: "https://www.youtube.com/@juavascript",
        icon: Icons.youtube,
        navbar: true,
      },
      email: {
  ...
  projects: [
    {
      title: "iconics",
      href: "https://ico-one-gray.vercel.app/",
    ...
    {
      title: "SSLtestify",
      href: "https://ssltestifier-nn7phjkmm-adamkaram.vercel.app/",
      dates: "Jan 2023 - Feb 2023",
      active: true,
      description:
        "Developed a full-stack web application to scan open ports of websites during inspection. I handled the project, focusing primarily on optimizing the site's response speed, which was the most critical issue to resolve",
      technologies: [
        "Next.js",
        "Typescript",
        "TailwindCSS",
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/Adamkaram/ssl-checker",
